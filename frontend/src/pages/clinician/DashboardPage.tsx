      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 rounded-2xl bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-start justify-between">
            <div>
              <h2 className="text-sm font-bold text-gray-900">Patient Risk Distribution</h2>
          ...
          {isLoading ? (
            ...
            <>
              <div className="space-y-5">
                <RiskBar label="High Risk"   count={highRisk}   pct={highPct}   dotColor="bg-red-500"    barColor="bg-red-400"  />
                <RiskBar label="Medium Risk" count={mediumRisk} pct={mediumPct} dotColor="bg-yellow-400" barColor="bg-yellow-400" />
                <RiskBar label="Low Risk"    count={lowRisk}    pct={lowPct}    dotColor="bg-secondary"  barColor="bg-secondary" />
              </div>

              {/* Stacked bar */}
              {total > 0 && (
                <div className="mt-5 flex h-3 w-full overflow-hidden rounded-full bg-gray-100">
                  <div className="bg-red-400 transition-all duration-700"    style={{ width: `${highPct}%` }}   title={`High: ${highPct}%`} />
                  <div className="bg-yellow-400 transition-all duration-700" style={{ width: `${mediumPct}%` }} title={`Medium: ${mediumPct}%`} />
                  <div className="bg-secondary transition-all duration-700"  style={{ width: `${lowPct}%` }}    title={`Low: ${lowPct}%`} />
                </div>
              )}
              ...
              <div className="mt-6 grid grid-cols-3 gap-px overflow-hidden rounded-xl bg-gray-100">
                ...
                <div className="bg-white px-4 py-4 text-center">
                  <p className="text-2xl font-bold text-gray-700">{assessmentsPerPatient}</p>
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <div className="space-y-2.5">
            ...
            <QuickAction
              ...
              cardBg="hover:bg-red-50 border-gray-100 hover:border-red-100"
